...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Mon Dec 15 20:19:12 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.hh NetSocket.hh Peer.hh FileMetadata.hh TrackedFileMetadata.hh DownloadWindow.hh ChordDHT.hh .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.cc NetSocket.cc Peer.cc FileMetadata.cc TrackedFileMetadata.cc DownloadWindow.cc ChordDHT.cc .tmp/peerster1.0.0/ && (cd `dirname .tmp/peerster1.0.0` && $(TAR) peerster1.0.0.tar peerster1.0.0 && $(COMPRESS) peerster1.0.0.tar) && $(MOVE) `dirname .tmp/peerster1.0.0`/peerster1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/peerster1.0.0
...
compiler_moc_header_make_all: moc_main.cpp moc_NetSocket.cpp moc_DownloadWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_main.cpp moc_NetSocket.cpp moc_DownloadWindow.cpp
