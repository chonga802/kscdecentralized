...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed Oct 22 21:09:19 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.hh NetSocket.hh Peer.hh SageTextEdit.hh PrivateMessageWindow.hh FileMetadata.hh DownloadWindow.hh .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.cc NetSocket.cc Peer.cc SageTextEdit.cc PrivateMessageWindow.cc FileMetadata.cc DownloadWindow.cc .tmp/peerster1.0.0/ && (cd `dirname .tmp/peerster1.0.0` && $(TAR) peerster1.0.0.tar peerster1.0.0 && $(COMPRESS) peerster1.0.0.tar) && $(MOVE) `dirname .tmp/peerster1.0.0`/peerster1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/peerster1.0.0
